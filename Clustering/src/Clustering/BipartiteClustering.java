...
public class BipartiteClustering {
    ...
    public BipartiteClustering(Map<String, String> params, boolean creatable){
       ...
       List<List<Cluster>> result = BipartiteClusteringByKMean_version2(index.matrix, 10, 10,
    ...
    private void printResult(List<Cluster> clusters, Map<String, String> params){
        //BufferedWriter writer = new BufferedWriter(new Writer(new File(params.get("output/bipartiteoutput"))));
    }
}
